package com.liyz.common.base.filter.dubbo;
...
public class RemoteServiceExceptionFilter extends ListenableFilter {

    public RemoteServiceExceptionFilter() {
        super.listener = new RemoteServiceExceptionFilter.ExceptionListener();
    }
    ...
    static class ExceptionListener implements Listener {
        private Logger logger = LoggerFactory.getLogger(RemoteServiceExceptionFilter.ExceptionListener.class);
